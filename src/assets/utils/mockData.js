...
export const usageTips = [
  { icon: 'icon-openbook', alt: 'openbook icon', text: '開箱後，請先確認甜點品項與保存方式' },
  { icon: 'icon-tea', alt: 'tea-cup icon', text: '搭配一杯茶或咖啡，更能襯托出甜點的風味' },
  { icon: 'icon-curtain', alt: 'curtain icon', text: '常溫甜點請置於陰涼乾燥處保存' },
  { icon: 'icon-eat', alt: 'eat icon', text: '開封後建議盡快食用，以確保最佳風味' },
];
