  ...
  return (
    <main className="main overflow-hidden">
      <section className="theme-banner bg-neutral-200">
        <picture>
          <source media="(min-width: 767px)" srcSet="./images/Theme_Page/banner-desktop.svg" />
          <img
            src="./images/Theme_Page/banner-mobile.svg"
        ...
        <div className="d-lg-none container text-center title-mobile">
          <img src="./images/Theme_Page/title-banner.svg" alt="總有一盒剛好是你想吃的甜" />
        </div>
      </section>
      {/* 主題一覽 */}
      <section className="position-relative">
        <div className="py-10 py-lg-11">
          <div className="mb-15 text-center">
            ...
            <picture>
              <source
                srcSet="./images/Theme_Page/title-theme-mobile.svg"
                media="(max-width: 992px)"
              />
              <img src="./images/Theme_Page/title-theme-desktop.svg" alt="主題一覽" />
            </picture>
          </div>
